    ...
    public function prepareDataSource(array $dataSource)
    {
        ...
        if (isset($dataSource['data']['items'])) {
            ...
            foreach ($dataSource['data']['items'] as & $item) {
                $product = $this->_objectManager->create('Magento\Catalog\Model\Product')->load($item['mageproduct_id']);                
                ...
                $item[$fieldName . '_description'] = strip_tags(html_entity_decode($product->getDescription()));
