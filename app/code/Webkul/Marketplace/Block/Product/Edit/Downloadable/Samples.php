...
class Samples extends \Magento\Framework\View\Element\Template
{
    ...
    public function getDownloadableSampleInfo()
    {
        ...
        $sampleData = $this->getSellerProduct()->getTypeInstance()->getSamples($this->getSellerProduct());
        ...
        foreach ($sampleData as $sample) {
            ...
            $getsampleInfo = $sample->getSampleFile();
            if ($getsampleInfo) {
                $sampleFilePath = $fileHelper->getFilePath($this->_downloadableSample->getBasePath(), $getsampleInfo);
