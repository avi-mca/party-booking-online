...
class Links extends \Magento\Framework\View\Element\Template
{
    ...
    {
        $linkArrObj = [];
        if ($this->getSellerProduct()->getTypeId() !== \Magento\Downloadable\Model\Product\Type::TYPE_DOWNLOADABLE) {
            return $linkArrObj;
        }
        $linkData = $this->getSellerProduct()->getTypeInstance()->getLinks($this->getSellerProduct());
        ...
        foreach ($linkData as $link) {
            ...
            if ($getlinkInfo) {
                $linkFilePath = $fileHelper->getFilePath($this->_downloadableLink->getBasePath(), $getlinkInfo);
            ...
            if ($getsampleInfo) {
                $sampleFilePath = $fileHelper->getFilePath(
                    $this->_downloadableLink->getBaseSamplePath(), $getsampleInfo
                );
